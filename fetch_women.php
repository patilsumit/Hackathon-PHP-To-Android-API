...
//    $wid = $_GET['wid'];
 $wcontact= $_GET['wcontact'];
    ...
    $result1 = mysqli_query($con,"select * from women where contact='$wcontact'");
    ...
    if (!empty($result1)) {
        ...
        if (mysqli_num_rows($result1) > 0) {
            ...
            $product["guardian_name"] = $result["guardian_name"];
            $product["guardian_number"] = $result["guardian_number"];
